  ...
  return (
    <section id="about" className="section-space relative px-3 sm:px-4">
      <div className="pointer-events-none absolute inset-0">
        <div className="about-gradient mx-auto mt-10 h-64 w-[90%] max-w-5xl rounded-full motion-reduce:animate-none" />
      </div>
      <div className="site-container relative max-w-5xl">
        <Reveal>
          <div className="glass-card px-6 py-10 transition-shadow duration-500 hover:shadow-[0_12px_40px_rgba(99,102,241,0.12)] dark:hover:shadow-[0_12px_40px_rgba(129,140,248,0.12)] md:px-10 md:py-12">
