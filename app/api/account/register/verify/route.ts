...
export async function POST(request: Request) {
  ...
  if (!result.ok) {
    const map = {
      not_found: "Сессия подтверждения не найдена. Запросите коды снова",
      expired: "Коды истекли. Запросите вход заново",
      max_attempts: "Слишком много попыток. Запросите снова",
      invalid_codes: "Неверный код из звонка или из письма"
    } as const;
